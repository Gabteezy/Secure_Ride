...
class RegisterAs : AppCompatActivity() {
    ...
    private fun setupButtonClickListeners() {
        binding.btnDriver.setOnClickListener {
            showRegisterForm("Driver", DriverRegister::class.java)
        }

//        binding.btnAdmin.setOnClickListener {
//            showRegisterForm("Admin", UserRegister::class.java)
//        }

        binding.btnCommuter.setOnClickListener {
            showRegisterForm("Commuter", UserRegister::class.java)
        }
    }


    private fun showRegisterForm(userType: String, destinationClass: Class<*>) {
        Log.d("REGISTER", userType)
        val intent = Intent(this@RegisterAs, destinationClass)
